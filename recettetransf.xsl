...
<xsl:template match="/">
		...
		<div id="footer">
			...
			<div id="section2">
				...
				<ul>
					...
					<li>
						<a href="http://www.regionpaca.fr/">Region PACA</a>
					</li>
				</ul>
			</div>
			<div id="section3">
		...
		<xsl:result-document href="index.xhtml">
			<html>
				...
				<body>
					...
					<h2><marquee>Bienvenue dans la page d'accueil</marquee></h2>
				<br/>
			<i>Une restauration de gout de delicatesse pour le plus grand plaisir des gourmands</i>
	         <br/>
			<i><b> Plus de 20 recettes proposées</b></i>
			...
			<xsl:for-each select="$rec5">
				<ul>
						 <img alt="image" style="width: 100px; height: 100px;">
												...
												</img><strong><a  href="{@id_rec}.xhtml"><font color="black"><xsl:value-of select="titre"/></font> </a></strong><p> </p>
				 </ul>
			</xsl:for-each><p> </p>
					...
					<body>
						...
						<div id="section4">
							<ul>
								...
								<li>
									<p>
										<strong>Liste des sous-categories         :</strong>
									</p>
									<!-- variable faisant le lien auteurs-recettes-->
	...
	<xsl:template name="fiche-produit">
		<xsl:for-each select="//produits/produit">
			...
			<xsl:result-document href="{@id_pro}.xhtml" encoding="utf-8">
				<html>
					<head>
						<title>AMU CUISINE</title>
						<link rel="stylesheet" href="styles.css" type="text/css" media="screen"/>
						...
						<div id="section4">
							<ul>
								<li>
									...
									<!-- variable faisant le lien produit-ingredient-->
									<xsl:variable name="refIngre" select="@id_pro"/>
									<xsl:variable name="ingre-produit" select="//ingredients/ingredient[produit=$refIngre]"/>
										<ul>
										<xsl:for-each select="$ingre-produit">
											<li>
												<p>
										<a href="{@id_ing}.xhtml">
											<font color="black">
